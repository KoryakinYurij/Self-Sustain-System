...
- Тело `SKILL.md` — **не более 500 строк** для оптимальной производительности
- **Лимит по словам**: простые workflow — **< 150 слов**, сложные — **< 500 слов**. Всё остальное → `references/`
